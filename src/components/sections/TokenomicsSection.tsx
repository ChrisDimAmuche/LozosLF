  ...
  return (
    <section className="py-12 sm:py-20 bg-black/80">
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Token Overview */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-16 auto-rows-fr">
        ...
        {/* Token Allocation */}
        <div className="bg-white/5 backdrop-blur-lg rounded-xl p-4 sm:p-6 lg:p-8 border border-white/10 mb-8 sm:mb-16">
          <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-4 sm:mb-6 lg:mb-8">Token Allocation</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 auto-rows-fr">
            {allocations.map((allocation) => (
              <div key={allocation.id} className="flex items-start space-x-3 sm:space-x-4">
                <div className="w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center bg-yellow-500/10 rounded-lg flex-shrink-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-16">
