  ...
  return (
    <section className="py-12 sm:py-20 bg-black/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Token Allocation */}
        <div className="bg-white/5 backdrop-blur-lg rounded-xl p-6 sm:p-8 border border-white/10 mb-8 sm:mb-16">
          <h3 className="text-xl sm:text-2xl font-bold text-white mb-6 sm:mb-8">Token Allocation</h3>
